      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-4 md:grid-cols-2 gap-12 mb-16">
        <div className="lg:col-span-1">
          <div className="flex items-center gap-3 mb-5">
            <img src="https://customer-assets.emergentagent.com/job_dental-ghaziabad/artifacts/ahaez3yf_Untitled%20design%20%282%29.png" alt="Smile Savers Dental Clinic" className="h-14 w-auto object-contain bg-bgmain rounded-xl p-1.5"/>
          </div>
